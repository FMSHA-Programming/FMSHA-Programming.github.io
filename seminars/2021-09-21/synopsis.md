...
**Упражнение 6**. Написать функцию, которая принимает строку и символ и определяет содержится ли символ в строке.

**Упражнение 7**. Написать функцию, которая принимает строку и определяет является ли она палиндромом. Строка содержит только строчные латинские символы.
