...
**Упражнение 1.**. Сгенерируйте массив из `100` случайных целых чисел от `-1000` до `1000` в ключительно и запишите его в файл `numbers.txt`, записывая каждое число с новой строки.
